...
lib.stashElementContents = function(id, where){
    ...
    where = el3.value;
    console.log(`We have now stashed ${el3.value} into ${where}`);
};
...
lib.deliver = function(what){
    ...
    var el1 = document.getElementById('customRadioInline1');
    var el2 = document.getElementById('customRadioInline2');
    var el3 = document.getElementById('customRadioInline3');
    stashElementContents();

    console.log(el1.checked, el2.checked, el3.checked);
    if(el2.checked === true){
...
lib.releaseCustomStr = function(s){
    var el3 = document.getElementById(s);
    console.log(`The value in the element is ${el3.value} and name is ${el3.name}`);
};

lib.stashedByUser = `Paste your text here`;

lib.darkString = `Dark matter is a type of matter thought to be responsible for much of the mass in the universe.
...
lib.canterburyString = `Whan that Aprille with his shoures soote,
...
/***  Initialize the page */
// to know when leaving radio-1 and hence where to stash the browser contents
var recentRadio = 'stashedByUser';
document.getElementById('zone-of-input').innerHTML = lib.stashedByUser; // Tab 1 box contents.

var el4 = document.getElementById('customRadioInline1');
var el5 = document.getElementById('zone-of-input');
el4.addEventListener('focus', buzz);
el5.addEventListener('focus', buzz);
el5.addEventListener('blur', buzz);
